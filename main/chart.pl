...
plot '../ouput/master/f_white' using 1:op:lo:hi:cl notitle with candlesticks lt 2,\
     '../output/master/f_black' using 1:op:lo:hi:cl notitle with candlesticks lt 1
unset label 1
unset label 2
unset title
