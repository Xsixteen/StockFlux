...
plot '../data/aapl_white' using 1:op:lo:hi:cl notitle with candlesticks lt 2,\
     '../data/aapl_black' using 1:op:lo:hi:cl notitle with candlesticks lt 1
unset label 1
unset label 2
unset title
...
plot '../data/aapl_white' using 1:vl notitle with impulses lt 2,\
     '../data/aapl_black' using 1:vl notitle with impulses lt 1
unset multiplot
